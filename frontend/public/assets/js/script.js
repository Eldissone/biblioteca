...
function createBookCard(book) {
    ...
    return `
      <div class="flex flex-col items-center bg-white rounded-lg shadow p-3 min-w-[180px]">
        <img src="${imageUrl}" alt="${book.title}" 
             class="w-32 h-44 object-cover rounded-md mb-2">
...
function closeReader() {
    const reader = document.getElementById("pdf-reader");
    reader.src = ""; // limpa para não ficar carregando em segundo plano
